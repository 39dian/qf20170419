...
+function ($) {
  ...
  PTR.prototype.touchMove= function(e) {
    ...
    if($(document.body).scrollTop() > 0) return;	//解决容器为div时scrollTop一直为0的问题 By zhangwei on 16/08/25
    var p = $.getTouchPosition(e);
...
+function ($) {
  ...
  Infinite.prototype.scroll = function() {
    ...
    var offset = container.scrollHeight() - (document.documentElement.clientHeight + container.scrollTop());	//解决容器$(window).height()取值错误的问题 By zhangwei on 16/08/25
